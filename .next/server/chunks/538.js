...
const _imageloader = /*#__PURE__*/ _interop_require_default._(__webpack_require__(21968));
...
const _addlocale = __webpack_require__(49236);
const _routercontext = __webpack_require__(17160);
const _approutercontext = __webpack_require__(57085);
const _useintersection = __webpack_require__(89639);
const _getdomainlocale = __webpack_require__(20582);
const _addbasepath = __webpack_require__(90464);
const _routerreducertypes = __webpack_require__(58071);
...
const _getimgprops = __webpack_require__(1830);
const _warnonce = __webpack_require__(98658);
const _imagecomponent = __webpack_require__(27230);
const _imageloader = /*#__PURE__*/ _interop_require_default._(__webpack_require__(21968));
...
module.exports = createProxy("C:\\Users\\user\\Desktop\\codeSpace\\html\\nextjsecom\\node_modules\\next\\dist\\client\\components\\app-router.js");
 //# sourceMappingURL=app-router.js.map
...
const _dynamicnossr = __webpack_require__(97020);
const _staticgenerationasyncstorage = __webpack_require__(97568);
function bailoutToClientRendering() {
    const staticGenerationStore = _staticgenerationasyncstorage.staticGenerationAsyncStorage.getStore();
    if (staticGenerationStore == null ? void 0 : staticGenerationStore.forceStatic) {
...
const _react = /*#__PURE__*/ _interop_require_default._(__webpack_require__(46842));
function clientHookInServerComponentError(hookName) {
    if (false) {}
}
if ((typeof exports.default === "function" || typeof exports.default === "object" && exports.default !== null) && typeof exports.default.__esModule === "undefined") {
...
const _react = __webpack_require__(46842);
const _approutercontext = __webpack_require__(59134);
const _hooksclientcontext = __webpack_require__(77489);
const _clienthookinservercomponenterror = __webpack_require__(97066);
const _getsegmentvalue = __webpack_require__(91684);
const _serverinsertedhtml = __webpack_require__(83038);
...
function useSearchParams() {
    ...
    if (true) {
        // AsyncLocalStorage should not be included in the client bundle.
        const { bailoutToClientRendering } = __webpack_require__(24614);
        if (bailoutToClientRendering()) {
            // TODO-APP: handle dynamic = 'force-static' here and on the client
            return readonlySearchParams;
        }
 ...
 * LICENSE file in the root directory of this source tree.
 */ 
var d = __webpack_require__(56821), e = {
...
exports.version = "18.3.0-experimental-9377e1010-20230712";
...
if (true) {
    module.exports = __webpack_require__(45581);
} else {}
...
exports.unstable_SuspenseList = C;
exports.unstable_getCacheForType = function(a) {
    var b = n.current;
    return b ? b.getCacheForType(a) : a();
};
...
if (true) {
    module.exports = __webpack_require__(69708);
} else {}
...
if (true) {
    module.exports = __webpack_require__(59267);
} else {}
 ...
 * LICENSE file in the root directory of this source tree.
 */ 
var aa = __webpack_require__(46842), ba = __webpack_require__(79187), l = null, m = 0;
function n(a, b) {
...
var q = Symbol.for("react.client.reference"), r = Symbol.for("react.server.reference");
function u(a, b, d) {
...
function nb(a, b, d, c) {
    ...
    if (void 0 !== g) return b[0] === y && "1" === d ? "$L" + g.toString(16) : T(g);
    try {
        ...
        a.pendingChunks++;
        var B = a.nextChunkId++, pa = N(A), C = B.toString(16) + ":I" + pa + "\n";
        var Gb = p.encode(C);
        a.completedImportChunks.push(Gb);
        f.set(e, B);
        return b[0] === y && "1" === d ? "$L" + B.toString(16) : T(B);
    } catch (Hb) {
        return a.pendingChunks++, b = a.nextChunkId++, d = P(a, Hb), Q(a, b, d), T(b);
    }
}
function ob(a, b) {
    a.pendingChunks++;
...
function eb(a, b, d, c) {
    ...
    for(; "object" === typeof c && null !== c && (c.$$typeof === y || c.$$typeof === D);)try {
        switch(c.$$typeof){
            case y:
                var e = c;
    ...
    if ("object" === typeof c) {
        ...
        return c instanceof Map ? "$Q" + ob(a, Array.from(c)).toString(16) : c instanceof Set ? "$W" + ob(a, Array.from(c)).toString(16) : c instanceof ArrayBuffer ? U(a, "A", new Uint8Array(c)) : c instanceof Int8Array ? U(a, "C", c) : c instanceof Uint8Array ? U(a, "c", c) : c instanceof Uint8ClampedArray ? U(a, "U", c) : c instanceof Int16Array ? U(a, "S", c) : c instanceof Uint16Array ? U(a, "s", c) : c instanceof Int32Array ? U(a, "L", c) : c instanceof Uint32Array ? U(a, "l", c) : c instanceof Float32Array ? U(a, "F", c) : c instanceof Float64Array ? U(a, "D", c) : c instanceof BigInt64Array ? U(a, "N", c) : c instanceof BigUint64Array ? U(a, "m", c) : c instanceof DataView ? U(a, "V", c) : !Wa(c) && (null === c || "object" !== typeof c ? a = null : (a = Ca && c[Ca] || c["@@iterator"], a = "function" === typeof a ? a : null), a) ? Array.from(c) : c;
    }
    if ("string" === typeof c) {
    ...
    if ("function" === typeof c) {
        if (c.$$typeof === q) return nb(a, b, d, c);
        if (c.$$typeof === r) return d = a.writtenServerReferences, b = d.get(c), void 0 !== b ? a = "$F" + b.toString(16) : (b = c.$$bound, b = {
            id: c.$$id,
            ...
            if (0 === f.status) {
                ...
                try {
                    ...
                    if ("object" === typeof k && null !== k && k.$$typeof === y) {
                        ...
                        f.model = k;
                        k = S(g, h.type, h.key, h.ref, h.props, t);
                        for(f.thenableState = null; "object" === typeof k && null !== k && k.$$typeof === y;)h = k, f.model = k, k = S(g, h.type, h.key, h.ref, h.props, null);
                    }
                    var z = pb(g, f.id, k);
...
yb.prototype = Object.create(Promise.prototype);
yb.prototype.then = function(a, b) {
    switch(this.status){
        case "resolved_model":
            zb(this);
    }
...
function Fb(a, b) {
    a._chunks.forEach(function(d) {
        "pending" === d.status && Bb(d, b);
    });
}
function Z(a, b) {
    var d = a._chunks, c = d.get(b);
    c || (c = a._formData.get(a._prefix + b), c = null != c ? new yb("resolved_model", c, null, a) : new yb("pending", null, null, a), d.set(b, c));
    return c;
}
function Db(a, b, d) {
    if (Y) {
    ...
    return function(e) {
        b[d] = e;
        c.deps--;
        0 === c.deps && "blocked" === a.status && (e = a.value, a.status = "fulfilled", a.value = c.value, null !== e && Ab(e, c.value));
    };
}
function Eb(a) {
    return function(b) {
...
function Jb(a, b, d, c) {
    if ("$" === c[0]) switch(c[1]){
        ...
        case "F":
            return c = parseInt(c.slice(2), 16), c = Ib(a, c), Cb(a, c.id, c.bound, X, b, d);
        case "Q":
            return b = parseInt(c.slice(2), 16), a = Ib(a, b), new Map(a);
        case "W":
            return b = parseInt(c.slice(2), 16), a = Ib(a, b), new Set(a);
        case "K":
            b = c.slice(2);
        ...
        default:
            ...
            switch(a.status){
                ...
                case "pending":
                case "blocked":
                    return c = X, a.then(Db(c, b, d), Eb(c)), null;
                default:
                    throw a.reason;
            }
    }
...
function Kb(a, b) {
    var d = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : new FormData, c = new Map, e = {
        ...
        _fromJSON: function(f, g) {
            return "string" === typeof g ? Jb(e, this, f, g) : g;
        }
    };
    return e;
}
function Lb(a) {
    Fb(a, Error("Connection closed."));
}
function Mb(a, b, d) {
    var c = ub(a, b);
    a = xb(c);
...
exports.decodeAction = function(a, b) {
    ...
    a.forEach(function(e, f) {
        if (f.startsWith("$ACTION_")) if (f.startsWith("$ACTION_REF_")) {
            ...
            e = e.value;
            c = Mb(b, e.id, e.bound);
        } else f.startsWith("$ACTION_ID_") && (e = f.slice(11), c = Mb(b, e, null));
        else d.append(f, e);
    });
...
if (true) {
    module.exports = __webpack_require__(62028);
} else {}
...
const { renderToReadableStream, decodeReply, decodeAction } = __webpack_require__(71377);
...
const _reactdom = /*#__PURE__*/ _interop_require_default(__webpack_require__(79187));
function _interop_require_default(obj) {
    return obj && obj.__esModule ? obj : {
        default: obj
    };
...
const _warnonce = __webpack_require__(57499);
const _imageblursvg = __webpack_require__(75348);
const _imageconfig = __webpack_require__(46276);
...
const _warnonce = __webpack_require__(57499);
const _imagecomponent = __webpack_require__(28986);
const _imageloader = /*#__PURE__*/ _interop_require_default._(__webpack_require__(80640));
const unstable_getImgProps = (imgProps)=>{
    (0, _warnonce.warnOnce)("Warning: unstable_getImgProps() is experimental and may change or be removed at any time. Use at your own risk.");
    const { props } = (0, _getimgprops.getImgProps)(imgProps, {
        defaultLoader: _imageloader.default,
...
module.exports = __webpack_require__(95876);
...
module.exports = __webpack_require__(31233);
...
module.exports = __webpack_require__(30143);
...
module.exports = __webpack_require__(22760)
...
module.exports = __webpack_require__(67120)
